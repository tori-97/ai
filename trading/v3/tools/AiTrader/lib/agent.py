...
from tools.AiTrader.models.dqn import DQN_Model
...
class Agent():
    ...
    BOTS_FOLDER_PATH = os.path.join(os.getcwd(), "backend/data/bots/")

    def __init__(self, name: str, balance: float, lr: float, gamma: float, batch_size: int, discounter_rate: int) -> None:
        self._name = name
        self.balance = balance
        self.LR = lr
        self.GAMMA = gamma
        self.BATCH_SIZE = batch_size
        self.DISCOUNTER = discounter_rate
    ...
    def save_current_status(self): 
        fpath  = os.path.join(self.BOTS_FOLDER_PATH, f"{self._name}/model")
