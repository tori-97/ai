...
class Browser():
    ...
    def download_files(self):
        ...
        for f in downloads_folder:
            if ".csv" in f:
                shutil.move(os.path.join(f"/home/tori/Downloads/", f), os.path.join(os.getcwd(), f"backend/data/train_data/{f}"))
    ...
    def sort_files(self, symbol):
        ...
        for file in free_files:
            ...
            if file in symbol_path:
                os.remove(os.path.join(symbol_path, file))
    ...
    def adapt_files(self, symbol: str):
        ...
        for f in symbol_files:
            file_path = os.path.join(symbol_path, f)
            self.adapt_file(file_path, symbol)
